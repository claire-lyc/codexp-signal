...
const demoTickets: DemoTicket[] = [
  ...
  {
    marker: 'DEMO-FH-FLOOD-002',
    reportType: 'environment',
    title: 'Flash flood',
    description: 'Water is rising along Jurong East Street 21 after heavy rain and pedestrians are unable to cross safely.',
    location: 'Jurong East Street 21, West',
    severity: 'high',
    status: 'submitted',
    agency: { code: 'PUB', name: 'Public Utilities Board' },
    subject: { label: 'Flash flood', categories: ['flood', 'weather'], description: 'Fast-rising water and flood-prone roads.' },
  ...
  {
    marker: 'DEMO-FH-FLOOD-003',
    reportType: 'environment',
    title: 'Drain overflow',
    description: 'Covered walkway near Yishun Avenue 5 is flooded because the side drain is overflowing into the footpath.',
    location: 'Yishun Avenue 5, North',
    severity: 'medium',
    status: 'submitted',
    agency: { code: 'PUB', name: 'Public Utilities Board' },
    subject: { label: 'Drain overflow', categories: ['flood', 'weather'], description: 'Overflowing drains and localised ponding.' },
  ...
  {
    marker: 'DEMO-FH-HEALTH-002',
    reportType: 'health',
    title: 'Dengue',
    description: 'Residents at Block 88 Redhill Close reported many mosquitoes and two neighbours with fever and rash.',
    location: 'Block 88 Redhill Close, Central',
    severity: 'high',
    status: 'submitted',
    agency: { code: 'MOH', name: 'Ministry of Health' },
    subject: { label: 'Dengue', categories: ['health'], description: 'Dengue symptoms, mosquito activity, and cluster reports.' },
  ...
  {
    marker: 'DEMO-FH-HEALTH-003',
    reportType: 'health',
    title: 'COVID-19',
    description: 'Several staff at a childcare centre in Woodlands are unwell with cough and positive COVID-19 tests.',
    location: 'Woodlands Street 31, North',
    severity: 'medium',
    status: 'in_progress',
    agency: { code: 'MOH', name: 'Ministry of Health' },
    subject: { label: 'COVID-19', categories: ['health'], description: 'Respiratory illness, COVID-19 clusters, testing, or isolation support.' },
    minutesAgo: 57,
    comments: [{ visibility: 'internal', body: 'MOH operations checking exposure count with centre manager.' }],
  },
  {
    marker: 'DEMO-FH-SUPPLY-002',
    reportType: 'supply',
    title: 'Medicine shortage',
    description: 'Guardian and Unity outlets near Tampines Hub are out of children fever medicine and residents are asking where to go.',
  ...
  {
    marker: 'DEMO-FH-SUPPLY-003',
    reportType: 'supply',
    title: 'Food shortage',
    description: 'NTUC at Serangoon Central has empty rice and bottled water shelves after long queues this morning.',
    location: 'Serangoon Central, North-East',
    severity: 'medium',
    status: 'submitted',
    agency: { code: 'Enterprise SG', name: 'Enterprise Singapore' },
    subject: { label: 'Food shortage', categories: ['supply'], description: 'Food stockout and essential grocery availability reports.' },
  ...
  {
    marker: 'DEMO-FH-INFRA-002',
    reportType: 'infrastructure',
    title: 'Power outage',
    description: 'Corridor lights and two lifts are down at Block 152 Pasir Ris Street 13 after a power outage.',
    location: 'Block 152 Pasir Ris Street 13, East',
    severity: 'high',
    status: 'in_progress',
    agency: { code: 'LTA', name: 'Land Transport Authority' },
    subject: { label: 'Power outage', categories: ['infrastructure'], description: 'Electricity outage or critical utility interruption.' },
  ...
  {
    marker: 'DEMO-FH-TRANSPORT-002',
    reportType: 'transport',
    title: 'Bus disruption',
    description: 'Large crowd waiting at Clementi interchange because several bus services are delayed and elderly commuters need assistance.',
    location: 'Clementi Bus Interchange, West',
    severity: 'medium',
    status: 'submitted',
    agency: { code: 'LTA', name: 'Land Transport Authority' },
    subject: { label: 'Bus disruption', categories: ['transport', 'infrastructure'], description: 'Bus service disruption, interchange crowding, and commuter safety reports.' },
    minutesAgo: 88,
  },
  {
    marker: 'DEMO-FH-CYBER-002',
    reportType: 'cybersecurity',
    title: 'Phishing campaign',
    description: 'Residents in Ang Mo Kio received SMS messages claiming to be a government subsidy link and asking for Singpass login.',
    location: 'Ang Mo Kio, North-East',
    severity: 'high',
    status: 'submitted',
    agency: { code: 'CSA', name: 'Cyber Security Agency of Singapore' },
    subject: { label: 'Phishing campaign', categories: ['cybersecurity'], description: 'Suspicious links, scam messages, and credential harvesting reports.' },
  ...
  {
    marker: 'DEMO-FH-ENV-002',
    reportType: 'environment',
    title: 'Heat concern',
    description: 'Ang Mo Kio central is extremely hot around the open plaza and several elderly residents are feeling dizzy.',
    location: 'Ang Mo Kio Central, North-East',
    severity: 'medium',
    status: 'submitted',
    agency: { code: 'NEA', name: 'National Environment Agency' },
    subject: { label: 'Heat concern', categories: ['environment', 'health'], description: 'Heat stress, extreme weather, and outdoor exposure concerns.' },
    minutesAgo: 105,
    pings: [{ code: 'MOH', name: 'Ministry of Health' }],
  },
  {
    marker: 'DEMO-FH-UNGROUPED-002',
    reportType: 'other',
    title: 'Other issue',
    description: 'Residents near Marine Parade hear a continuous public warning siren but cannot identify the source agency.',
    location: 'Marine Parade Road, East',
    severity: 'low',
    status: 'submitted',
    agency: { code: 'GOV-OPS', name: 'Government Operations' },
    minutesAgo: 116,
  ...
  {
    marker: 'DEMO-FH-ARCHIVE-002',
    reportType: 'transport',
    title: 'Road obstruction',
    description: 'Fallen branch previously blocking one lane along Upper Thomson Road has been cleared by response crew.',
    location: 'Upper Thomson Road, Central',
    severity: 'low',
    status: 'resolved',
    agency: { code: 'LTA', name: 'Land Transport Authority' },
    subject: { label: 'Road obstruction', categories: ['transport', 'infrastructure'], description: 'Blocked lanes, road hazards, and traffic obstruction reports.' },
    minutesAgo: 210,
    comments: [{ visibility: 'public', body: 'The obstruction has been cleared and traffic flow has returned to normal.' }],
  },
  {
  ...
  {
    marker: 'DEMO-FH-SPAM-004',
    reportType: 'health',
    title: 'Other health issue',
    description: 'test test test rainbow unicorn emergency lol',
    location: 'Unknown',
    severity: 'low',
    status: 'rejected',
    agency: { code: 'MOH', name: 'Ministry of Health' },
  ...
  {
    marker: 'DEMO-FH-SPAM-005',
    reportType: 'supply',
    title: 'Food shortage',
    description: 'buy now free voucher click here subscribe',
    location: 'Unknown',
    severity: 'low',
    status: 'rejected',
    agency: { code: 'Enterprise SG', name: 'Enterprise Singapore' },
  ...
  {
    marker: 'DEMO-FH-SPAM-006',
    reportType: 'other',
    title: 'Other issue',
    description: 'qwerty qwerty qwerty qwerty qwerty qwerty qwerty qwerty',
    location: 'Unknown',
    severity: 'low',
    status: 'rejected',
    agency: { code: 'GOV-OPS', name: 'Government Operations' },
